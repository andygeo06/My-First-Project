...
def load_sheet_data(url, sheet_name):
    # This URL encoding is critical. If the sheet name is wrong in Google Sheets, 
    # it silently returns the very first sheet instead!
...
try:
    ...
    # Load NOM and PMR exactly as named in Google Sheets
    ...
    # We grab exactly the 4 columns you built in PMR
    df_pmr = df_pmr_raw.iloc[:, :4].fillna("")
    
    # We grab exactly the 9 columns generated by your Google Sheet QUERY
